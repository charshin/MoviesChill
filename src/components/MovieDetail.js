...
export default withStyles(styles)(({
  ...
  <Grid container spacing={24} className={classes.rootContainter}>
    <Grid item xs={12}>
        ...
        <Grid container>
          ...
          <Grid item xs>
            <CardContent>
              ...
              <Typography variant="overline" gutterBottom>{moment(released).isValid() ? moment(released).format('MMMM DD, YYYY') : 'Unknown release date'}</Typography>
